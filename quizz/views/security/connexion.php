...
<div  class="connexion-form-body bgWhite p-3">
      <?php
        ...
        ?>
    <form id="connexion-form-1" class="py-2" method="post" action="<?=BASE_ROOT?>security/connexion">
        ...
        <button type="submit" id="btn_connexion" class="btn btn-primary" name="btn_connexion">Connexion</button>
        <a id="btn_inscription" href="#" lien="<?=BASE_ROOT?>security/view/inscription" class="text-secondary pl-5">S'inscrire pour jouer</a>
    </form>
</div>
